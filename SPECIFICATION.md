...
6. **As an Admin/Developer**, I want to change request statuses (_Planned_, _In Progress_, _Completed_) so that users know the development roadmap.
...
- **P1:** Status tags filter (_Planned_, _In Progress_, _Completed_), Search & sort requests by votes.
